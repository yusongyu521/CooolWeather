...
public class CooolWeatherOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_COUNTY="create table County(id integer primary key autoincrement," +
            "county_name text,county_code text,city_id integer,weather_id text)";
    public CooolWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
